...
# Ex : If you're having a big script and if your script fails and it's really challenging to figure out the mistake as it makes us to watch over the entire script from the beginning.
# Instead, we can use exit codes everyWhere to find out where our script failures.